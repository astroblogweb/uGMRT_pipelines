...
recipe = stimela.Recipe('uGMRT A4038 2gc reduction script', ms_dir=MSDIR)
...
recipe.add('cab/wsclean', 'image_target_field_r0', 
           {
               "msname"        :   MS,
               #"field"         :   TARGET,
               #"channelrange"  :   [50,55],               #Other channels don't have any data   
               ...
               "fit-spectral-pol" : 3,
               "mgain"         :   0.9,
               "auto-threshold":   20, # Shallow clean
...
recipe.add('cab/wsclean', 'image_target_field_r1', 
           {
               ...
               #"threshold"     : 0.00003, #Jy
               "multiscale"    : True,
               "auto-threshold":   15,                      #Shallow clean
               "joinchannels"  :   True,
               "channelsout"   : 3,
               #"deconvolution-channels" : 2,
               "fit-spectral-pol" : 3,
...
recipe.add("cab/calibrator", "calibrator_Gjones_subtract_lsm0", 
           {
               ...
               "threads"            : 16,
               "column"             : "DATA",
               "output-data"        : "CORR_DATA", # Corr_Data (gain applied) - Model in CORRECTED_DATA column
               "Gjones"             : True,
               "Gjones-solution-intervals" : [300,0], # Ad-hoc right now, subject to change (14 time slot ~ 5 min, 30 channel)
...
recipe.add('cab/cleanmask', 'mask1', 
           {
               ...
               "image"  : '%s-MFS-image.fits:output' %(imname2),
...
recipe.add("cab/pybdsm", "extract_pselfcal_model", 
           {
               "image"             :  '%s-MFS-image.fits:output' %(imname3),
               "outfile"           :  '%s.fits:output'%(lsm1),
               "thresh_pix"        :  50,
               "thresh_isl"        :  10,
               "port2tigger"       :  True,
               "clobber"           : True,
...
recipe.add("cab/calibrator", "calibrator_Gjones_subtract_lsm1", 
           {
               ...
               "threads"            : 16,
               "column"             : "DATA",
               "output-data"        : "CORR_DATA", # Corr_Data (gain applied) - Model
               "Gjones"             : True,
               "Gjones-solution-intervals" : [60,100], # Ad-hoc right now, subject to change (3 time slot ~ 1 min, 30 channel)
               "correlations"       :  '2x2, diagonal terms only', # Added  
...
recipe.add('cab/cleanmask', 'mask2', 
           {
               #    "image"  : "pre-self-cal--image.fits:output",
               "image"  : '%s-MFS-image.fits:output' %(imname4),
...
recipe.add("cab/pybdsm", "extract_pselfcal_model", 
           {
               "image"             :  '%s-MFS-image.fits:output' %(imname5),
               "outfile"           :  '%s.fits:output'%(lsm3),
               "thresh_pix"        :  10,
               "thresh_isl"        :  5,
               "port2tigger"       :  True,
               "clobber"           : True,
...
recipe.add("cab/calibrator", "calibrator_Gjones_subtract_lsm3", 
           {
               ...
               "threads"            : 16,
               "column"             : "DATA",
               "output-data"        : "CORR_DATA", # Final residual data
               "Gjones"             : True,
               "Gjones-solution-intervals" : [60,10], # Ad-hoc right now, subject to change (14 time slot ~ 5 min, 30 channel)
               "correlations"       :  '2x2, diagonal terms only', # Added  
...
recipe.add("cab/tigger_restore", "restore_image", 
           {
               "input-image"   :  '%s-MFS-image.fits:output' %(imname6), # res img after amp & phase self-cal
               #"input-image"   :  '%s-MFS-image.fits:output' %(imname5), # res img after 2 rounds of phase self-cal
               "input-skymodel"  : "%s.lsm.html:output"%(lsm4),
               "output-image"   :  '%s-MFS-image.fits:output' %(imname7),
